...
const RecipeMaker = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 min-h-screen w-full flex items-center justify-center">
      <div className="p-6 max-w-2xl w-full mx-auto animate-fade-in">
